...
class AgentPlanningDraftServiceTest {
    ...
    void shouldPersistAndReloadStructuredPlanningSlots() {
        ...
        service.save(1L, "conversation-1", 12L, spec);
        ...
        Map<String, Object> loaded = service.load(1L, "conversation-1");
    ...
    void redisFailureShouldDegradeToEmptyDraft() {
        ...
        assertThat(service.load(1L, "conversation-2")).isEmpty();
        service.clear(1L, "conversation-2");
